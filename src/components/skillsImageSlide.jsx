...
function skillsImageSlide({ title, alt, img, svg  }) {
    ...
    return (
      <div className="slide">
        ...
        <Card className="my-2">
            ...
            <div className="w-full svg-container" dangerouslySetInnerHTML={{ __html: svg }} />
  ...
  export default skillsImageSlide;